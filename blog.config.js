...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '辰石', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '梦想挣几个打发凡夫俗子的铜板', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.chenshi1.top', // 网站地址
